...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PodCompletionPermitArgs)(nil), (*config.PodCompletionPermitArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_PodCompletionPermitArgs_To_config_PodCompletionPermitArgs(a.(*PodCompletionPermitArgs), b.(*config.PodCompletionPermitArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PodCompletionPermitArgs)(nil), (*PodCompletionPermitArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PodCompletionPermitArgs_To_v1_PodCompletionPermitArgs(a.(*config.PodCompletionPermitArgs), b.(*PodCompletionPermitArgs), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1_PodCompletionPermitArgs_To_config_PodCompletionPermitArgs is an autogenerated conversion function.
func Convert_v1_PodCompletionPermitArgs_To_config_PodCompletionPermitArgs(in *PodCompletionPermitArgs, out *config.PodCompletionPermitArgs, s conversion.Scope) error {
	return autoConvert_v1_PodCompletionPermitArgs_To_config_PodCompletionPermitArgs(in, out, s)
}
...
// Convert_config_PodCompletionPermitArgs_To_v1_PodCompletionPermitArgs is an autogenerated conversion function.
func Convert_config_PodCompletionPermitArgs_To_v1_PodCompletionPermitArgs(in *config.PodCompletionPermitArgs, out *PodCompletionPermitArgs, s conversion.Scope) error {
	return autoConvert_config_PodCompletionPermitArgs_To_v1_PodCompletionPermitArgs(in, out, s)
}
