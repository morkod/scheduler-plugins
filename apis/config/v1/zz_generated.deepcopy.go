...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodCompletionPermitArgs) DeepCopyInto(out *PodCompletionPermitArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.DependencyIndicatorLabel != nil {
		in, out := &in.DependencyIndicatorLabel, &out.DependencyIndicatorLabel
		*out = new(string)
		**out = **in
	}
	if in.PodAppSelector != nil {
		in, out := &in.PodAppSelector, &out.PodAppSelector
		*out = new(string)
		**out = **in
	}
	...
	if in.PostfixSelector != nil {
		in, out := &in.PostfixSelector, &out.PostfixSelector
		*out = new(string)
		**out = **in
	}
	if in.DependencyKind != nil {
		in, out := &in.DependencyKind, &out.DependencyKind
		*out = new(string)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodCompletionPermitArgs.
func (in *PodCompletionPermitArgs) DeepCopy() *PodCompletionPermitArgs {
	if in == nil {
		return nil
	}
	out := new(PodCompletionPermitArgs)
	in.DeepCopyInto(out)
	return out
}

func (in *PodCompletionPermitArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
